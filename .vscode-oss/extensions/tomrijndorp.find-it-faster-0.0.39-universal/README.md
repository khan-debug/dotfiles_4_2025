...
⬇️ &nbsp;**Find files**  
![Find Files](https://github.com/tomrijndorp/vscode-finditfaster/raw/HEAD/media/find_files.gif)

⬇️ &nbsp;**Find text within files**  
![Find Within Files](https://github.com/tomrijndorp/vscode-finditfaster/raw/HEAD/media/find_within_files.gif)

⬇️ &nbsp;**Find text within files, with file type filter**  
![Find Within Files](https://github.com/tomrijndorp/vscode-finditfaster/raw/HEAD/media/find_within_files_with_filter.gif)
...
stage. Please file an issue on [Github](https://github.com/tomrijndorp/vscode-finditfaster/blob/HEAD/ https:/github.com/tomrijndorp/vscode-finditfaster/issues)
if you find one.
